<p>介紹 : 這是程式設計課程中製作的戰鬥機類型遊戲，使用C & Allegro寫，遊戲包含角色選擇、角色升級、背景音樂、按鍵配樂、進度永久存檔、顯示我方敵方血量等。<p>
<p>內容 : code皆寫在game.cbp，其中利用很多function，如game_initial(初始化)、game_update(遊戲進行時不斷更新)、game_draw(編輯圖檔音樂檔)等。<p>
